        ...
        <div className="w-full flex justify-center">
            <Card className="max-w-[400px]">
                <CardBody className="overflow-visible p-0">
                    <Image className="object-cover" alt="logo" height={600} radius="sm" src={CommunityImage} width={600} />
                </CardBody>
                ...
                <CardFooter className="flex-col">
                    ...
                    <div className="py-5">
                        <p className="text-center text-sm pb-5">Please enter the email address you provided during event registration.</p>
                        <Input
                            type="email"
                            label="Email"
