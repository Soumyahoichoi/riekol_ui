...
//         endTime: '3:30 PM',
//         Image: [],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1695978005516.jpeg',
//         totalslot: 50,
//         name: 'MyEO RIE Golf Tournament',
//         whatInclude:
...
//             ' Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
//         description:
//             'Golf Tournament on the 10th and 11th of January 2024. Played over two rounds:A)10th Jan - The Tollygunge Club - Established in 1895 and spread over a 100 acres. (Optional) B)11th Jan - The Royal Calcutta Golf Club - Established in 1829, is the oldest golf club outside the British Isles. Expect exhilerating competition, fantastic camaraderia, and tons of surprise goodies along the way. Valid home course handicap mandatory.',
//         mystatus: 1,
//         mywaitstatus: 0,
...
//         ],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1695727527358.jpeg',
//         totalslot: 40,
//         name: 'MyEO Hare Krishna',
//         whatInclude:
//             'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
//         whattoBring:
//             ' Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
//         mystatus: 0,
//         mywaitstatus: 1,
//         eventChampion: 'Champion- Alok Saraf-  9831025657 ',
...
//         ],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1695983032031.jpeg',
//         totalslot: 30,
...
//         cancPolicy: 'Eden Gardens',
//         addInfo: 'Eden Gardens',
//         description: "The oldest Tea Auctioneer in the world opens it's doors for an EO Kolkata exclusive! Participate in a private tea tasting and tea auction!",
//         mystatus: 0,
//         mywaitstatus: 0,
...
//         startTime: '15:30 PM',
//         endTime: '6:00 PM',
//         Image: ['https://riekolstorageaccount.blob.core.windows.net/eocontainer/1695973930465.jpeg', 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1695973931379.jpeg'],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1695973931446.jpeg',
//         totalslot: 15,
//         name: 'MyEO Born into brothel',
...
//         ],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1696235398107.jpeg',
//         totalslot: 35,
//         name: 'MyEO Eden Gardens',
...
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1696243214770.jpeg',
//         totalslot: 15,
//         name: 'MyEO Culture & Cuisine',
//         whatInclude: 'Lifejacket\nLogistics from ITC and Back"\n',
//         whattoBring: 'Please wear comfortable shoes as you may have to walk on wet surfaces\n',
...
//         description:
//             'A unique way to discover the city and immerse oneself in an evening of art, culture cuisine & converstaions. The man of the hour, "Bomti Iyengar" is a city fanatic, art collector & interior designer, a well known name across global travellers as a warm host who offers the real taste of Kolkata at home. ',
//         mystatus: 1,
//         mywaitstatus: 0,
...
//         ],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1696314705211.jpeg',
//         totalslot: 40,
//         name: 'MyEO Food Crawl',
...
//         description: "Join us on a foodie adventue through iconic Park Street's most hallowed F&B insitutions! If you truly live to eat, not eat to live, this one is unmissable!",
//         mystatus: 0,
//         mywaitstatus: 0,
...
//         ],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1696315732905.jpeg',
//         totalslot: 40,
//         name: 'My EO Learning with Amartya Sen',
//         whatInclude: '',
//         whattoBring: '',
//         whattoExpect: '',
//         meetingPoint: '',
...
//         addInfo: '',
//         description:
//             "Nobel Laureate Amartya Sen, one of the most distinguished economists & philosphers of our time, takes you through his ground breaking ideas on economics, ethics & socal justice at one of Kolkata's most iconic historical monuments! ",
//         mystatus: 0,
//         mywaitstatus: 0,
...
//         ],
//         thumb_image: 'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1696316159468.jpeg',
//         totalslot: 30,
...
//         cancPolicy: '',
//         addInfo: '',
//         description: 'Come and witness how Jute is processed and woven into a modern fabric. At the end of the tour enjoy a meal fit for the landlords of the British Raj.',
//         mystatus: 0,
//         mywaitstatus: 0,
...
//     // 	totalslot: 20,
//     // 	name: 'MyEO Victoria Memorial Tour',
//     // 	whatInclude: '',
//     // 	whattoBring: '',
//     // 	whattoExpect: '',
//     // 	meetingPoint: '',
...
//     // 	mystatus: 0,
//     // 	mywaitstatus: 0,
//     // 	priceId: 'price_1Ny9joSCdrsL4rvtWnhRCgl4'
//     // },
//     // {
//     // 	_id: '651bbaf8106ac7006c32ec37',
//     // 	eoDate: null,
...
//     // 		'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1696316159468.jpeg',
//     // 	totalslot: 20,
//     // 	name: 'MyEO Governor House visit',
//     // 	whatInclude: '',
//     // 	whattoBring: '',
//     // 	whattoExpect: '',
//     // 	meetingPoint: '',
...
//     // 	mystatus: 0,
//     // 	mywaitstatus: 0,
//     // 	priceId: 'price_1Ny9l6SCdrsL4rvtAjDlirL0'
//     // },
//     // {
//     // 	_id: '651bbaf8106ac7006c32ec37',
//     // 	eoDate: null,
...
//     // 	mystatus: 0,
//     // 	mywaitstatus: 0,
//     // 	priceId: 'price_1Ny9lTSCdrsL4rvth86wnYmu'
//     // },
//     // {
//     // 	_id: '651bbaf8106ac7006c32ec37',
//     // 	eoDate: null,
...
//     // 		'https://riekolstorageaccount.blob.core.windows.net/eocontainer/1696316159468.jpeg',
//     // 	totalslot: 20,
//     // 	name: 'North Kolkata auto rickshaw tour Kolkata Walks',
//     // 	whatInclude: '',
//     // 	whattoBring: '',
//     // 	whattoExpect: '',
//     // 	meetingPoint: '',
...
//     // 	mystatus: 0,
//     // 	mywaitstatus: 0,
//     // 	priceId: 'price_1Ny9lsSCdrsL4rvtHDAYjMAb'
//     // },
//     // {
//     // 	_id: '651bbaf8106ac7006c32ec37',
//     // 	eoDate: null,
...
//     // 	mystatus: 0,
//     // 	mywaitstatus: 0,
//     // 	priceId: 'price_1Ny9mWSCdrsL4rvtlauvQtjh'
//     // },
//     // {
//     // 	_id: '651bbaf8106ac7006c32ec37',
//     // 	eoDate: null,
...
//     // 	mystatus: 0,
//     // 	mywaitstatus: 0,
//     // 	priceId: 'price_1Ny9mwSCdrsL4rvtIZ3WxABI'
//     // },
//     // {
//     // 	_id: '651bbaf8106ac7006c32ec37',
//     // 	eoDate: null,
...
//     // 	mystatus: 0,
//     // 	mywaitstatus: 0,
//     // 	priceId: 'price_1Ny9p7SCdrsL4rvtSi08DLWu'
//     // }
// ];
